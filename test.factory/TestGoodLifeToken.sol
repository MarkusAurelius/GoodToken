...
contract TestGoodLifeToken {
    ...
    GLTMerchantSaleFactory merchantSaleFactory;
    ...
    function beforeEach() public {
        ...
        merchantSaleFactory = GLTMerchantSaleFactory(DeployedAddresses.GLTMerchantSaleFactory());
   ...
   function testCustomerBalanceRedeemTokens() public {
    ...
    function buyAndCollectTokens(uint numberOfTokens) private {
       emit LogBuyAndCollectTokens(numberOfTokens);
       merchantSaleFactory = new GLTMerchantSaleFactory(ethRate, wallet);
       merchantSale = merchantSaleFactory.gltMerchantSale();
